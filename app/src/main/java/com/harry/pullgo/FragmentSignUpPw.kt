    ...
    private val pwWatcher=object: TextWatcher {
        ...
        override fun afterTextChanged(s: Editable?) {
            ...
            if(checkPw(s.toString())){
                ...
                binding.signUpPwLayout.setHelperTextColor(ColorStateList.valueOf(resources.getColor(R.color.material_700_green)))
            }
            ...
            if(!checkPwSame(binding.signUpPwCheck.text.toString())){
                ...
                binding.signUpPwCheckLayout.setHelperTextColor(ColorStateList.valueOf(resources.getColor(R.color.material_700_green)))
