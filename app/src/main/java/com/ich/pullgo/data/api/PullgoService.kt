...
interface PullgoService {
    ...
    suspend fun teacherUsernameExists(@Path("username")username: String): Response<ExistDto>
    ...
    @GET("academies/")
    suspend fun getAcademiesTeacherApplying(@Query("applyingTeacherId")teacherId: Long): Response<List<Academy>>

    @GET("academy/classrooms/")
    suspend fun getClassroomsTeacherApplying(@Query("applyingTeacherId")teacherId: Long): Response<List<Classroom>>
    ...
    suspend fun studentUsernameExists(@Path("username")username: String): Response<ExistDto>
    ...
    @GET("academies/")
    suspend fun getAcademiesStudentApplying(@Query("applyingStudentId")studentId: Long): Response<List<Academy>>

    @GET("academy/classrooms/")
    suspend fun getClassroomsStudentApplying(@Query("applyingStudentId")studentId: Long): Response<List<Classroom>>
    ...
    suspend fun getOneAttenderState(@Path("id")attenderStateId: Long): Response<AttenderState>
